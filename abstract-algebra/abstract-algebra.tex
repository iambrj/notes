...
the elements of $A$. The kernel is normal subgroup of $G$. Note that this
definition is in agreement with the perspective of an action as a homomorphism
from $G$ to $S_A$
\end{definition}
...
\begin{definition}{Orbit}{}
    If $G$ is a group acting on a set $A$, the \textbf{orbit} of an element
    $a\in A$ is defined as $\{a\prime\in A\mid\exists g\in G$ such that $a\prime = g$ \ding{72}
    $a\}$. Equivalently, orbit of $a$ is $\{g $\ding{72}$a\mid\forall g\in G\}$.
\end{definition}
...
\begin{proposition}{}{}
    For any element $x\in G$ of an arbitrary group $G$, and $a\in
        ...
        \end{enumerate}
\end{proposition}
Intuition - look at the cycle generated by $x$ and where $x^a$ lies on this cycle
