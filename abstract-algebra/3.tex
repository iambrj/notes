...
$uN\cap vN = \phi$ for distinct $u$ and $v$ since otherwise $uN\subseteq vN$ and
$vN\subseteq uN$ implying $uN = vN$.
\begin{proposition}{}{}
...
\begin{theorem}{Second Isomorphism Theorem/\\Diamond Isomorphism Theorem}{}
    ...
    $AB$ is a subgroup of $G$, $B\trianglelefteq AB$, $A\cup B\trianglelefteq$
    and $AB/B\cong A/A\cup B$.
\end{theorem}
